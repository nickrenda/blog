...
male_height <- qplot(x,y, mHeights, geom="line") 
male_height
```
...
male_height + 
  ...
  geom_segment(aes(x=67, y=0, xend=67, yend=dnorm(67,70,3))) +
  geom_segment(aes(x=73, y=0, xend=73, yend=dnorm(73,70,3))) +
  xlab("z") + ylab("") + annotate("text", x=70, y=0.05, label="68%", size=14)
```
...
male_height + 
  ...
  xlab("z") + ylab("") + annotate("text", x=68.5, y=0.05, label="34%", size=8)
```
...
male_height + 
  ...
  geom_segment(aes(x=73, y=0, xend=73, yend=dnorm(73,70,3))) +
  geom_segment(aes(x=70, y=0, xend=70, yend=dnorm(70,70,3))) +
  xlab("z") + ylab("") + annotate("text", x=71.5, y=0.05, label="34%", size=8)
```
...
male_height + 
  geom_ribbon(data=subset(mHeights, x >= 60 & x <= 67), aes(ymax=y), ymin=0, fill="red",
              colour=NA, alpha=0.5) +
  geom_segment(aes(x=67, y=0, xend=67, yend=dnorm(67,70,3))) +
  xlab("z") + ylab("") + annotate("text", x=62.5, y=0.06, label="(100-68)/2\n=16%", size=8)
```
...
male_height + 
  geom_ribbon(data=subset(mHeights, x >= 67 & x <= 80), aes(ymax=y), ymin=0, fill="red",
              colour=NA, alpha=0.5) +
  geom_segment(aes(x=67, y=0, xend=67, yend=dnorm(67,70,3))) +
  xlab("z") + ylab("") + annotate("text", x=77.4, y=0.06, label="(100-16)=84%", size=8)
```
...
male_height + 
  geom_ribbon(data=subset(mHeights, x >= 73 & x <= 80), aes(ymax=y), ymin=0, fill="red",
              colour=NA, alpha=0.5) +
  geom_segment(aes(x=73, y=0, xend=73, yend=dnorm(73,70,3))) +
  xlab("z") + ylab("") + annotate("text", x=77.5, y=0.06, label="(100-68)/2\n=16%", size=8)
```
...
male_height + 
  geom_ribbon(data=subset(mHeights, x >= 60 & x <= 73), aes(ymax=y), ymin=0, fill="red",
              colour=NA, alpha=0.5) +
  geom_segment(aes(x=73, y=0, xend=73, yend=dnorm(73,70,3))) +
  xlab("z") + ylab("") + annotate("text", x=62.6, y=0.06, label="(100-16)=84%", size=8)
```

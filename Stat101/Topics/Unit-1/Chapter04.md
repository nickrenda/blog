...
Boxplot pros vs cons
========================================================

- Cons
    - Multiple modes cannot be distinguished through boxplots
- Pros
    - Easy, quick way of summarizing data that includes a lot of information
        - Center, spread/variability, skewness
    - Great for comparing distributions
    - Easy to distinguish outliers
